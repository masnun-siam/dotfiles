...
M.general = {
	...
	n = {
		...
		["<leader><leader>"] = { ":Telescope find_files<cr>", "telescope find_files", opts = opts },
		...
		["sf"] = { ":Telescope file_browser<cr>", "telescope file browser", opts = opts },
		...
		["<leader>o"] = { ":Telescope lsp_document_symbols<cr>", "Telescope document symbols", opts = opts },
	},
}
-- more keybinds!
