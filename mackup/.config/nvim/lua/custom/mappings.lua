...
M.general = {
  n = {
    ...
    ["<leader>w"] = { ":Telescope builtin diagnostics<cr>", "vim lsp diagnostics", opts = opts },
    [";f"] = { ":Telescope builtin find_files<cr>", "telescope find_files", opts = opts },
    [";e"] = { ":Telescope builtin diagnostics<cr>", "telescope diagnostics", opts = opts },
